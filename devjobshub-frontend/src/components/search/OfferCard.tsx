        ...
        <div className='flex flex-row space-x-2'>
          <div className='flex flex-col items-end gap-y-1'>
            {offer.minSalaryUoP !== null && <div className='font-normal'>
              <Badge variant={'secondary'} className='text-sm'><span>{offer.minSalaryUoP} - {offer.maxSalaryUoP} zł (employment contract)</span> </Badge>
            </div>}
            {offer.minSalaryB2B !== null && <div className='font-normal'>
              <Badge variant={'secondary'} className='text-sm'><span>{offer.minSalaryB2B} - {offer.maxSalaryB2B} zł (B2B)</span> </Badge>
            </div>}
